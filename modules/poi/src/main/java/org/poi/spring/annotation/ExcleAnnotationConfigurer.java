...
public class ExcleAnnotationConfigurer implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry beanDefinitionRegistry) throws BeansException {
        ...
        for (String beanName : candidateBean) {
            ...
            Annotation annotation = AnnotationUtils.getAnnotation(originClass, ExcleWorkBook.class);
            if (annotation != null) {
                ...
                if (attributesMap.get("name") == null) {
                    throw new ExcelException("Annotation ExcleWorkBook name not fand originClass=" + originClass.getName());
                }
